...
public class MstCategoryTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(MstCategory.class).id(1L).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_relCategoryMovieList() throws Exception {
        jdbcManager.from(MstCategory.class).leftOuterJoin(relCategoryMovieList()).id(1L).getSingleResult();
    }
}